    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold tracking-tight text-zinc-900 dark:text-white uppercase">
              LSPB BARANG CEK NON-BCL
            </h2>
            <p className="text-sm text-zinc-500 dark:text-zinc-400">
              Laporan selisih pengecekan barang Non-BCL (Lebih / Kurang).
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="rounded-lg border-2 border-zinc-950 dark:border-zinc-700 bg-zinc-100 dark:bg-zinc-800 p-5 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
          ...
          <p className="text-3xl font-extrabold text-rose-600 dark:text-rose-400">{stats.totalMinus}</p>
          <span className="text-xs text-zinc-600 dark:text-zinc-400 mt-1 block">
        ...
        <div className="rounded-lg border-2 border-zinc-950 dark:border-zinc-700 bg-zinc-100 dark:bg-zinc-800 p-5 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
          ...
          <p className="text-3xl font-extrabold text-green-600 dark:text-green-400">{stats.totalPlus}</p>
          <span className="text-xs text-zinc-600 dark:text-zinc-400 mt-1 block">
            Checking qty &gt; original qty
          </span>
        </div>
