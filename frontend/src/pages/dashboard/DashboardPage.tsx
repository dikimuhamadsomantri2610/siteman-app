    ...
    <div className="flex min-h-[70vh] items-center justify-center p-4">
      <div className="relative overflow-hidden rounded-3xl p-8 sm:p-12 shadow-2xl text-center max-w-lg w-full border border-white/10"
        ...
        <div className="relative z-10 flex flex-col items-center">
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-white/10 border border-white/20 backdrop-blur-md mb-6 animate-bounce">
            <LayoutDashboard className="h-8 w-8 text-indigo-200" />
          </div>
          ...
          <p className="text-indigo-200/85 text-sm sm:text-base max-w-sm leading-relaxed">
            Halaman dashboard operasional sedang dalam pengembangan. Silakan akses menu navigasi di samping untuk mengelola data.
          </p>
        </div>
      </div>
    </div>
